...
DROP USER IF EXISTS 'jonas'@'localhost';
...
/*  
    ...
    para o usuario.
*/
CREATE USER 'jonas'@'localhost'
   IDENTIFIED BY 'mypass'
;

-- Concede permissao para manipular as tabelas

GRANT ALL PRIVILEGES ON * . * TO 'jonas'@'localhost';
FLUSH PRIVILEGES;
...
ALTER TABLE cargos COMMENT 'Tabela de cargos contendo';

ALTER TABLE cargos MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'Pk da tabela';

ALTER TABLE cargos MODIFY COLUMN cargo VARCHAR(35) COMMENT 'Conten o nome do cargo';

ALTER TABLE cargos MODIFY COLUMN salario_minimo DECIMAL(8, 2) COMMENT 'Conten o salario base';

ALTER TABLE cargos MODIFY COLUMN salario_maximo DECIMAL(8, 2) COMMENT 'Conten o salario maximo';
...
ALTER TABLE regioes MODIFY COLUMN id_regiao INTEGER COMMENT 'PK da tabela de regioes;';

ALTER TABLE regioes MODIFY COLUMN nome VARCHAR(25) COMMENT 'Chave secundaria';
...
ALTER TABLE paises COMMENT 'Tabela de paises';

ALTER TABLE paises MODIFY COLUMN id_pais CHAR(2) COMMENT 'PK da tabela';

ALTER TABLE paises MODIFY COLUMN nome VARCHAR(50) COMMENT 'Chave secundaria.';

ALTER TABLE paises MODIFY COLUMN id_regiao INTEGER COMMENT 'FK da tabela de regioes';
...
ALTER TABLE localizacoes COMMENT 'Tabela de localizacoes';

ALTER TABLE localizacoes MODIFY COLUMN id_localizacao INTEGER COMMENT 'Pk da tabela';

ALTER TABLE localizacoes MODIFY COLUMN endereco VARCHAR(50) COMMENT 'Contem o endereco';

ALTER TABLE localizacoes MODIFY COLUMN cep VARCHAR(12) COMMENT 'Codigo postal';

ALTER TABLE localizacoes MODIFY COLUMN cidade VARCHAR(50) COMMENT 'Cidade do departamento.';

ALTER TABLE localizacoes MODIFY COLUMN uf VARCHAR(25) COMMENT 'Codigo do estado';

ALTER TABLE localizacoes MODIFY COLUMN id_pais CHAR(2) COMMENT 'FK da tabela de paises';
...
ALTER TABLE departamentos MODIFY COLUMN id_departamento INTEGER COMMENT 'Chave primaria';
...
ALTER TABLE empregados MODIFY COLUMN nome VARCHAR(75) COMMENT 'Nome do funcionario';
...
ALTER TABLE empregados MODIFY COLUMN data_contratacao DATE COMMENT 'Data da contratacao';

ALTER TABLE empregados MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'FK da tabela de empregados';

ALTER TABLE empregados MODIFY COLUMN salario DECIMAL(8, 2) COMMENT 'Coluna contendo salario';

ALTER TABLE empregados MODIFY COLUMN comissao DECIMAL(4, 2) COMMENT 'Comissao do funcionario';

ALTER TABLE empregados MODIFY COLUMN id_departamento INTEGER COMMENT 'FK da tabela de departamentos';

ALTER TABLE empregados MODIFY COLUMN id_supervisor INTEGER COMMENT 'FK de auto relacionamento';
...
ALTER TABLE historico_cargos COMMENT 'Tabela de historico';

ALTER TABLE historico_cargos MODIFY COLUMN data_inicial DATE COMMENT 'PK da tabela';

ALTER TABLE historico_cargos MODIFY COLUMN id_empregado INTEGER COMMENT 'Codigo do empregado';

ALTER TABLE historico_cargos MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'Codigo do cargo';

ALTER TABLE historico_cargos MODIFY COLUMN id_departamento INTEGER COMMENT 'PK da tabela';
